// build/dist/pkg/common/index-53969585.js
...
function Card({
  ...
  return /* @__PURE__ */ react.createElement("div", {
    ...
    onClick: () => {
      handleArrowClick(id2, "right");
    }
  }));
}

// build/dist/components/Column.js
function Column({
  title,
  items,
  type,
...
// build/dist/utils/idGenerator.js
...
var idGenerator_default = IdGenerator;
...
function App() {
  ...
  function handleSubmit(e) {
    ...
    if (e.keyCode === 13 || e.target.getAttribute("data-clicked")) {
      const id2 = idGenerator_default(toDoItems);
      setToDoItems((prevItems) => [
        ...prevItems,
        {text: toDoText, status: "todo", id: id2}
      ]);
      setToDoText(() => "");
    }
  }
  ...
  function handleArrowClick(id2, arrowType) {
    let currentIndex;
